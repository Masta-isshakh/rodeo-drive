  ...
  return (
    <div className="about-page">
      ...
      <section className="about-team">
        ...
        <div className="team-grid">
          <div className="team-member">
            <img src="https://images.unsplash.com/photo-1546443046-ed1ce6ffd1d3?auto=format&fit=crop&w=800&q=60" />
            <h3>{t("about.team.member1.name")}</h3>
            <p>{t("about.team.member1.role")}</p>
          </div>

          <div className="team-member">
            <img src="https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?auto=format&fit=crop&w=800&q=60" />
            <h3>{t("about.team.member2.name")}</h3>
            <p>{t("about.team.member2.role")}</p>
          </div>

          <div className="team-member">
            <img src="https://images.unsplash.com/photo-1564869730310-4adf0a1b1f6f?auto=format&fit=crop&w=800&q=60" />
      ...
      <section className="about-cta">
        ...
        <a className="cta-btn" href="/contact">{t("about.cta_btn")}</a>
      </section>
